...
|------|-------------|-------|
| `01_Project_Overview.md` | Executive summary, tech stack, current status | ~2 pages |
...
| `09_Product_UI_Screenshots_Guide.md` | Screen inventory + capture guide | ~2 pages |
| `10_2_Minute_Demo_Script.md` | Word-for-word presentation script + Q&A backup | ~3 pages |
| `11_Expected_Impact_and_ROI.md` | ROI projections, TAM, 3-year scale model | ~4 pages |
...
| **Scale capacity** | 10,000+ students (Firebase scale) |
| **Grant request** | ₹46,000 |
| **Year 1 direct ROI** | ₹5.34 Lakhs (11.6x) |
| **TAM** | 23,500+ institutions in India |

---

## How to Use This Pack

- **For VC/investor pitch**: Lead with `01`, then `05`, then `11`
- **For grant committee**: Lead with `04`, then `07`, then `08`
- **For technical jury**: Lead with `02` + `03`, then `06`
- **For live demo**: Follow `10_2_Minute_Demo_Script.md` exactly

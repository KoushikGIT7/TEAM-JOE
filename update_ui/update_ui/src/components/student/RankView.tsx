          ...
          <>
            ...
            <section className="relative">
              <div className="glass-bg glass-stroke rounded-3xl p-6 flex flex-col items-center text-center overflow-hidden bg-[#171f33]/40">
                ...
                <div className="flex gap-2.5 mt-5">
                  ...
                  <div className="px-3.5 py-1.5 rounded-full bg-[#10b981]/15 border border-[#10b981]/30 flex items-center gap-1.5 select-none">
            ...
            <section className="space-y-3">
              <div className="flex items-center justify-between select-none">
                ...
                <div className="flex items-center gap-1 text-[#10b981] font-mono text-[10px] font-bold">
                  <Flame className="w-4 h-4 fill-[#10b981]" />
                  ...
                  <div key={item.day} className="flex flex-col items-center gap-2 shrink-0">
                    ...
                    <div className={`w-9 h-11 rounded-full flex items-center justify-center border transition-all ${
                      item.isCurrent 
                        ...
                        : item.active 
                          ? 'bg-brand-green/10 border-[#10b981]/30' 
              ...
              {rank2 && (
                <div className="flex-1 flex flex-col items-center">
                  <div className="relative mb-2 shrink-0">
                    <div className="w-12 h-12 rounded-full border border-white/10 overflow-hidden bg-[#1e293b] p-0.5">
                      <img 
                        alt="" 
              ...
              {rank1 && (
                <div className="flex-1 flex flex-col items-center scale-110 shrink-0 transform translate-y-[-8px]">
                  <div className="relative mb-2.5">
                    ...
                    <div className="w-14 h-14 rounded-full border-2 border-[#10b981] overflow-hidden bg-[#1e293b] p-0.5 shadow-lg shadow-brand-green/20">
                      <img 
                        alt="" 
                        className="w-full h-full object-cover rounded-full" 
                        src={rank1.avatar}
                  ...
                  <div className="glass-bg border-b-0 border border-[#10b981]/30 w-full h-24 rounded-t-xl flex flex-col items-center justify-center bg-brand-green/5">
